...
class StatusActionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_mark_captured_when_api_is_creditcard_create_and_success()
    {
        $this->validate([
    ...
    public function test_mark_captured_when_api_is_creditcard_create_and_fail()
    {
        $this->validate([
            'link_id' => '0xwRd4gYVBHo',
            'cust_order_no' => '',
    ...
    public function test_mark_canceled_when_api_is_creditcard_cancel_and_success()
    {
        $this->validate([
            'link_id' => '0xwRd4gYVBHo',
    ...
    public function test_mark_refunded_when_api_is_creditcard_cancel_and_success()
    {
        $this->validate([
            'link_id' => '0xwRd4gYVBHo',
            'cust_order_no' => '',
    ...
    public function test_mark_captured_when_api_is_creditcard_authorized_and_success()
    {
        $this->validate([
            'ret' => 'OK',
    ...
    public function test_mark_failed_when_api_is_creditcard_authorized_and_fail()
    {
        $this->validate([
            'ret' => 'FAIL',
            'cust_order_no' => '20120403000003',
    ...
    public function test_mark_captured_when_apn_status_is_b()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
    ...
    public function test_mark_suspended_when_apn_status_is_o()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
            'trans_id' => '550e8400e29b41d4a716446655440000',
    ...
    public function test_mark_captured_when_apn_status_is_e()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
            'trans_id' => '550e8400e29b41d4a716446655440000',
    ...
    public function test_mark_failed_when_apn_status_is_f()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
            'trans_id' => '550e8400e29b41d4a716446655440000',
    ...
    public function test_mark_expired_when_apn_status_is_d()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
            'trans_id' => '550e8400e29b41d4a716446655440000',
    ...
    public function test_mark_failed_when_apn_status_is_p()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
            'trans_id' => '550e8400e29b41d4a716446655440000',
    ...
    public function test_mark_cancaled_when_apn_status_is_m()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
            'trans_id' => '550e8400e29b41d4a716446655440000',
    ...
    public function test_mark_failed_when_apn_status_is_n()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
            'trans_id' => '550e8400e29b41d4a716446655440000',
    ...
    public function test_mark_refunded_when_apn_status_is_q()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
            'trans_id' => '550e8400e29b41d4a716446655440000',
    ...
    public function test_mark_failed_when_apn_status_is_r()
    {
        $this->validate([
            'api_id' => 'CC0000000001',
            'trans_id' => '550e8400e29b41d4a716446655440000',
